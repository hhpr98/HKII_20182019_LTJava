...
@WebServlet("/capnhatpj")
public class EditPjServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        try
        {
            ...
            RequestDispatcher rd = getServletContext().getRequestDispatcher("/editpj.jsp");
            rd.forward(request,response);
        }
        catch (Exception ex)
        {
            Logger.getLogger(EditPjServlet.class.getName()).log(Level.SEVERE,null,ex);
        }
    }
    ...
    protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
    {
        ...
        try
        {
            ...
            Project item=new Project(id,name,location,num,cost,start,end);
            pjDAO.update(item);
