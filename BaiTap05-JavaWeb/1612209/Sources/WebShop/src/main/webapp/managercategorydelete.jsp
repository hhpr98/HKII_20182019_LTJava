<%-- 
    Document   : managercategorydelete
    Created on : May 4, 2019, 9:10:36 PM
    Author     : nguyenhuuhoa
--%>
	...
	<!-- Header section end -->
        ...
        <div>
            <form action="" method="POST">
                ...
                <center><h3>Xóa loại sản phẩm</h3></center>
                </br>
                <center><h4>Bạn có muốn xóa loại sản phẩm ${requestScope.item.name} với mã id = ${requestScope.item.id} không?</h4></center>
                </br>
