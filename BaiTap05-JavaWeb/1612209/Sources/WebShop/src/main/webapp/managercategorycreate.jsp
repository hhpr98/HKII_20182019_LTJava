<%-- 
    Document   : managercategorycreate
    Created on : May 4, 2019, 8:46:59 PM
    Author     : nguyenhuuhoa
--%>
...
<body>
	...
	<!-- Header section end -->
        ...
        <div>
            ...
            <center><h3>Tạo mới loại sản phẩm</h3></center>
            <form action="" method="POST">
                </br>
                <div class="form-group">
                    <label>Tên loại sản phẩm:</label>
                    <input type="text" class="form-control" name="txtName" id="txtName" value="Loại sản phẩm mới">
                </div>
                </br>
